...
class ResConfigSettings(models.TransientModel):
    ...
    shift_exchange_policy = fields.Selection(
        [
            ...
            (
                "registraion_standard",
                "Participations put into exchange plus available standard seats",
            ),
            (
                "registraion_standard_ftop",
                "Participations put into exchange plus available standard seats"
                " plus available ftop seats",
            ),
        ],
    ...
    show_advance_service = fields.Boolean(
        related="company_id.show_advance_service", readonly=False
    )
