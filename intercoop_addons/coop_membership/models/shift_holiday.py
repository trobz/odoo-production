...
class ShiftHoliday(models.Model):
    ...
    def attribute_point_qty_long_period(self):
        ...
        for attendee in attendees:
            ...
            if self.make_up_type == '0_make_up':
                ...
                if (attendee.shift_type == 'standard' and attendee.state ==
                    'absent' and attendee.template_created)\
                    or (attendee.shift_type == 'ftop' and
    ...
    def attribute_point_qty_single_day(self):
        ...
        for attendee_closed in attendee_in_closed_shifts:
            count_vals_closed = {}
            if attendee_closed.shift_type == 'standard' and\
                    attendee_closed.template_created:
            ...
            elif attendee_closed.shift_type == 'ftop':
        ...
        for attendee_open in attendee_in_open_shifts:
            if (attendee_open.state == 'absent' and attendee_open.template_created and
                attendee_open.shift_type == 'standard') or\
                (attendee_open.shift_type == 'ftop' and
