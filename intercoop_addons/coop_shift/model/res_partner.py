        ...
        for partner in self:
            ...
            if current_leave:
                partner.current_leave_info = "".join(
                    e[0].upper() for e in current_leave.type_id.name.split())\
                    + "-" + current_leave.stop_date.split('-')[2] + '/' +\
                    current_leave.stop_date.split('-')[1] + '/' +\
                    current_leave.stop_date.split('-')[0]
            else:
        ...
        for partner in self:
            ...
            if current_extension:
                partner.current_extension_day_end =\
                    current_extension.date_stop.split('-')[2] + '/' +\
                    current_extension.date_stop.split('-')[1] + '/' +\
                    current_extension.date_stop.split('-')[0]
            else:
