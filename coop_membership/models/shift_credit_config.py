...
class ShiftCreditConfig(models.Model):
    ...
    _description = "Shift Credit Config"

    credited_make_ups = fields.Selection(
        selection=[("0.5", "0.5"), ("1.5", "1.5"), ("2", "2")],
        required=True,
    ...
    end_date = fields.Date(string="Date de clôture de l’exception")
    state = fields.Selection(
        selection=[("active", "Active"), ("cancel", "Canceled")], default="active"
    )
