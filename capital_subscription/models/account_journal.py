...
class AccountJournal(models.Model):
    ...
    is_capital_fundraising = fields.Boolean(
        string="Used for Sales of Capital Fundraisings", default=False
    )
    ...
    confirm_fundraising_payment = fields.Selection(
        string="Confirm Fundraising Payments",
        default="yes",
        selection=CONFIRM_FUNDRAISING_PAYMENT_SELECTION,
        help="Setting"
    ...
    is_capital_refund_fundraising = fields.Boolean(
        string="Used for Refunds of Capital Fundraising", default=False
    )
