...
class CoopshiftLeaveTest(TransactionCase):
    def setUp(self):
        ...
        self.shiftleave_id = self.shift_leave_type.create({"name": "Congé Parental"})
        self.standard_member_1 = self.model_data._xmlid_to_res_id(
        ...
        self.regular_stop_date = self.expected_birthdate + relativedelta(years=1)
